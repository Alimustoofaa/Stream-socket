...
class WebSocket(tornado.websocket.WebSocketHandler):
    ...
    def loop(self):
        ...
        if args.use_usb:
            camera = cv2.VideoCapture('http://192.168.0.11:9080/mjpg/video.mjpg')
...
parser.add_argument("--use-usb", default='http://192.168.0.11:9080/mjpg/video.mjpg', action="store_true", help="Use a USB "
